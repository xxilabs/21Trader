/*
  ...
  21Trader is fork from Gekko, a Bitcoin trading bot for popular Bitcoin exchanges written
...
console.log('21Trader v' + util.getVersion());
...
if(
  ...
  !config['I understand that 21Trader only automates MY OWN trading strategies']
)
  util.die('Do you understand what 21Trader will do with your money? Read this first:\n\nhttps://github.com/askmike/gekko/issues/201');
